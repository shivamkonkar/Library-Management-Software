Oracle.ManagedDataAccess NuGet Package 21.4.0 README
=====================================================
...
Bug Fixes since Oracle.ManagedDataAccess NuGet Package 21.3.0
=============================================================
...
Bug 33075190 - BLOB DATA SMALLER THAN INITIALLOBFETCHSIZE GETS PADDED WITH INCORRECT DATA WHEN RETRIEVED 
...
Bug 33293917 - UDTS WITH NULLABLE DATETIME ATTRIBUTES HAVE ISSUES WHEN SAVING DATA BACK TO THE DATABASE
Bug 33402710 - INTEGER BASED PARTS OF GUID/RAW(16) ARE INCORRECTLY REVERSED
Bug 33458553 - ORACLECOMMANDBUILDER AUTOGENERATION IGNORES DATAADAPTER'S SELECT COMMAND
